  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Card className="bg-white/70 backdrop-blur-sm border-amber-200/50">
          <CardHeader>
          ...
          <CardContent>
            <p className="text-gray-600">Track your learning progress with weekly reports and weak point analysis.</p>
          </CardContent>
        </Card>
      </div>
    </div>
